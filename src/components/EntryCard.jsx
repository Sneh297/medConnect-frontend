                    ...
                    <div className="flex flex-col gap-4">
                        <div>
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                ...
                                <InfoChip icon={Rss} label="Subscriber" value={subscriber} />
                                <InfoChip icon={Radio} label="Heard Via" value={heard} />
                            </div>
                        </div>
                        {expect && (
                            <div className="p-3.5 rounded-xl bg-white/[0.04] border border-white/[0.07]">
                                <div className="flex items-center gap-1.5 text-slate-500 mb-1.5">
                                    ...
                                    <span className="text-[10px] font-semibold uppercase tracking-wider">Expectations</span>
                                </div>
                                <p className="text-sm text-slate-200 leading-relaxed">{expect}</p>
                            </div>
                        )}
                    </div>
